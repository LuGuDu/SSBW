...
def update_book_form(bookNew, id):
    book = get(id)
    
    book.title=bookNew['title']
    book.author=bookNew['author']
    book.genre=bookNew['genre']
    book.description=bookNew['description']
    book.isbn=bookNew['isbn']
    book.published=bookNew['published']
    book.publisher=bookNew['publisher']
